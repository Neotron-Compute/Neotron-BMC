...
//!
//! This implementation assumes that the core clock is set to 48 MHz (see
//! `CORE_CLOCK` constant). At 48 MHz, this means 20.833 ns per clock cycle.
//!
//! If we use a prescaler value of 6144, that means 20.833 ns * 6144 = 128 µs per
//! timer tick. This corresponds to a frequency of 48 MHz / 6144 = 7.8125 kHz.
//!
